...
<template>
  <div class="scrollSettings h-full w-full flex  flex-col justify-center py-14 px-10 sm:px-8 sm:justify-start">
    ...
    <span class="w-[80%] mb-10 text-lg border-l-2 border-[#fca61f] pl-4 "
      ...
      devoloping myself in the field of Front-end and web3 since 2019.</span
    >
    <div class="">
       <a href="https://github.com/emirhan-yagci?tab=repositories" target="_blank">
      <span class="bg-[#fca61f] px-5 py-3 rounded-xl font-bold cursor-pointer hover:bg-[#f19602]" style="box-shadow: 0 0 51px rgb(250 137 54 / 74%);">See My Works</span>
      </a>
        </div>
  </div>
</template>
